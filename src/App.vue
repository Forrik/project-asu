<template>
  <div>
    <div v-if="userStore.user.isAuthenticated" class="personal-area">
      ...
      <button @click="logout" to="/login" class="personal-area__btn">
        <i class="icon"
          ><svg xmlns="http://www.w3.org/2000/svg" fill="#707070" width="27px" height="27px" viewBox="0 0 24 24">
            <path
            ...
            /></svg
        ></i>
        <span class="personal-area__text">Выйти</span>
      </button>
    </div>
    ...
    <nav v-if="userStore.user.isAuthenticated" class="sidebar">
      ...
      <div class="menu-bar">
        <div class="menu">
          <ul class="menu-links">
            <RouterLink v-if="userStore.user.isAdmin" to="/specialties">
            ...
            <RouterLink v-if="userStore.user.isAdmin" to="/teachers">
            ...
            <RouterLink v-if="userStore.user.isAdmin" to="/graduation">
              <li class="nav-link" :class="{ active: activeIndex === 2 }" @click="setActive(2)">
                <a href="#">
                  ...
                  <span class="text nav-text">Выпуск</span>
                </a>
              </li>
            </RouterLink>
            <RouterLink v-if="userStore.user.isAdmin" to="/directory">
            ...
            <RouterLink v-if="userStore.user.isStudent" to="/my-tickets">
              <li class="nav-link">
                <a href="#">
                  <i class="icon"><TicketIcon /></i>
                  <span class="text nav-text">Мои заявки</span>
                </a>
              </li>
            </RouterLink>
            <RouterLink v-if="userStore.user.isTeacher" to="/tickets">
              <li class="nav-link">
                <a href="#">
                  <i class="icon"><TicketIcon /></i>
                  <span class="text nav-text">Заявки</span>
                </a>
              </li>
            </RouterLink>
          </ul>
...
.personal-area__btn:first-child {
  margin-right: 15px;
}
